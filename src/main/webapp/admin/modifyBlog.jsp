...
<script type="text/javascript">
    ...
    ue.addListener("ready",function(){
    	// 通过ajax请求数据
    	UE.ajax.request("${pageContext.request.contextPath}/admin/blog/queryBlogInfoById.do",
    			{
    				method:"post",
    				async:false,
    				data:{"id":"${param.id}"},
    				onsuccess:function(result){
    					...
    					$("#keyword").val(entity.keyword);
    					$("#blogTypeId").combobox("setValue",entity.blogType.id);
    					UE.getEditor('editor').setContent(entity.content);
    				}
   			});
    });
</script>
