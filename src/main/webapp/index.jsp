...
<body style="background-color: #d0d0d0">
	<div class="constainer" >
		<div class="row">
				<div class="col-md-4">
					<img alt="CinCommonBlog"
						src="${pageContext.request.contextPath}/static/images/logo.png">
				</div> 
				<div class="col-md-8">
					<iframe style="float: right;" width="300" scrolling="no"
						height="25" frameborder="0" allowtransparency="true"
						src="http://i.tianqi.com/index.php?c=code&id=10&bdc=%23&icon=4&site=12"></iframe>
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-md-3">
				<%-- 				<div class="data_list">
					...
					<div class="user_image">
						<img
							src="${pageContext.request.contextPath}/static/userImages/20160202095456.jpg" />
					</div>
